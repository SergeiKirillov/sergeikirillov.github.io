...
---
Утилиты Sysinternals для устранения неполадок были объединены в единый набор инструментов. Этот файл содержит отдельные инструменты для устранения неполадок и файлы справки. Он не содержит инструменты, не связанные с устранением неполадок, такие как заставка BSOD.
...
- [Registry Usage (RU)](https://learn.microsoft.com/en-us/sysinternals/downloads/ru), 
